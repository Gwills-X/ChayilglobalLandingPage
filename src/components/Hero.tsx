...
export default function Hero() {
  return (
    <section
      ...
      <div className='relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-12 lg:gap-24'>
        ...
        <div className='flex-1 text-center md:text-left'>
          <motion.div
            ...
            <span className='text-[#DFFF8F] font-mono text-xs md:text-sm tracking-[0.3em] uppercase mb-4 block'>
              Kingdom Institutional Platform
            </span>
            <h1 className='text-3xl sm:text-5xl lg:text-6xl font-serif font-bold mb-6 leading-[1.1] tracking-tight mx-auto md:mx-0'>
          ...
          <motion.p
            ...
            className='text-base sm:text-lg text-gray-300 mb-10 leading-relaxed max-w-xl mx-auto md:mx-0 font-light'>
          ...
          <motion.div
            ...
            <p className='text-[10px] uppercase tracking-[0.2em] text-gray-500 max-w-xs leading-relaxed'>
          ...
          <motion.div
            ...
            <div className='relative aspect-square w-full'>
              <Image
                ...
                className='object-contain drop-shadow-[0_0_30px_rgba(223,255,143,0.2)]'
              />
            </div>
          </motion.div>
        </div>
