...
export default function Network() {
  return (
    <section
      ...
      <div className='absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-40 bg-[#c6a85a]/10 blur-[100px] rounded-full pointer-events-none' />
      ...
      <div className='relative z-10 max-w-6xl mx-auto'>
        ...
        <div className='text-center mb-20'>
          <motion.h2
            ...
            The Chayil Global{" "}
            <span className='text-[#c6a85a]'>Founding Network</span>
          </motion.h2>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24'>
          {targetAudience.map((item, i) => (
            <motion.div
              ...
              className='group relative p-8 rounded-[2rem] border border-white/5 bg-gradient-to-b from-white/5 to-transparent backdrop-blur-sm transition-all hover:border-[#c6a85a]/20'>
              <div className='w-2 h-2 rounded-full bg-[#c6a85a] mb-6 shadow-[0_0_10px_#DFFF8F]' />
              <h3 className='text-lg font-bold mb-3 group-hover:text-[#c6a85a] transition-colors'>
                {item.title}
              </h3>
        ...
        <motion.div
          ...
          <h3 className='text-xl font-bold mb-8 text-[#c6a85a] text-center uppercase tracking-widest'>
            Member Privileges
          </h3>
          <div className='grid sm:grid-cols-2 gap-6'>
            {memberBenefits.map((benefit, idx) => (
              <div key={idx} className='flex items-center gap-4 text-gray-300'>
                <span className='text-[#c6a85a] text-xl'>✦</span>
        ...
        <motion.div
          ...
          <motion.div
            ...
            className='h-[1px] bg-gradient-to-r from-transparent via-[#c6a85a]/30 to-transparent mx-auto mt-8'
          />
        </motion.div>
      </div>
    </section>
