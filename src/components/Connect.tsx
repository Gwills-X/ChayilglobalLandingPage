...
export default function Connect() {
  return (
    <section
      ...
      <div className='absolute bottom-0 left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] h-[250px] md:h-[400px] bg-[#c6a85a]/10 blur-[120px] rounded-full pointer-events-none' />
      ...
      <div className='relative z-10 w-full max-w-4xl mx-auto text-center'>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='inline-block px-4 py-1 rounded-full border border-[#c6a85a]/30 text-[#c6a85a] text-[10px] font-mono mb-6 md:mb-8 uppercase tracking-widest'>
        ...
        <motion.h2
          ...
          Begin Your{" "}
          <span className='text-[#c6a85a]'>Strategic Partnership</span>
        </motion.h2>
        ...
        <motion.div
          ...
          <a
            className='w-full sm:w-auto px-8 sm:px-10 py-4 rounded-full bg-[#c6a85a] text-black font-bold text-sm hover:bg-white transition-all hover:scale-105 active:scale-95'
